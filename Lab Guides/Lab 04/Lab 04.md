...
11. Select **Next**. Leave the next step as is and select **Review Mapping**
   ...
   >[!Alert] **Alert:** If you do not see the mapping to be proper in the page, then select **Back** and select the **Data Delimiter** to be **None** and select **Review Mapping**
   >
   >![](./media/image31.png)
