...
1.  Open the link,
    +++<https://appsource.microsoft.com/en-cy/product/dynamics-365/mscrm.omnichannelpvaextension?tab=Overview&ref=dynamicsforcrm.com+++> and
    click on **Get it now** in the Omnichannel Power Virtual Agent
    Extension page.
...
1.  From the Copilot Studio home page,
    ...
    select the **CustomerService Trial** Environment from the top right.
...
1.  Login to
    +++[https://admin.powerplatform.microsoft.com+++](https://admin.powerplatform.microsoft.com+++/) using
    your admin tenant credentials. Select **Manage** from the left pane.
    Select **CustomerService Trial** environment **under Environments**.
