# 실습 02 - Dynamics 365 고객 서비스 구성하기

## 목표

이 실습에서는 **Dynamics 365 Customer Service** 평가판을 활성화합니다.
...
이 실습에서는 실습 **04 - 안전한 여행 에이전트를 개선하고 다중 에이전트
오케스트레이션**을 구현하는 데 사용될 Dynamics 365 Customer Service를
활성화했습니다.
