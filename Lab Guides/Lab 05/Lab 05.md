...
您在之前的实验中，使用 Copilot Studio 提供的模板创建了一个名为 **Safe Travels** 的代理。在本实验中，您将了解如何增强该代理以满足特定客户的需求。

在此过程中，您将学习 Copilot Studio 中的代理流程创建和多代理编排的概念
...
8.  现在，选择一个 **Text** input 并将其命名为 +++**Purpose**+++。
...
13. 在 Message 字段中，输入以下内容
    ...
    将 **<Employee ID>** 和 **<Purpose>** 替换为动态内容变量 **Employee ID** 和 **Purpose**，如下面的屏幕截图所示。
